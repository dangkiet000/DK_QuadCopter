...
/*------------------------------------------------------------------------------ 
          ...
          TX1 A3  D11   ----------------     P1.3  AIN3  TXD1
              A4  D12   ----------------     P1.4  AIN4  SS0
              A5  D13   ----------------     P1.5  AIN5  MOSI0
              A6  D14   ----------------     P1.6  AIN6  MISO0
(Measure Vcc) A7  D15   ----------------     P1.7  AIN7  SPICLK0
...
*******************************************************************************/
/* Ard_PinType */
#define GPIO_TYPE   0x00U
#define UART_TYPE  	0x01U
#define I2C_TYPE   	0x02U
#define SPI_TYPE		0x04U
#define ADC_TYPE 		0x08U
#define PWM_TYPE 		0x10U

#define ARDUINO_MAX_PIN_COUNT 39U

/*******************************************************************************
**                      Global Data Types                                     **
*******************************************************************************/
typedef uint8_t Ard_PinType;

/*******************************************************************************
**                      Global Declarations                                   **
*******************************************************************************/
extern const Ard_PinType Arduino_PinType[];

/*******************************************************************************
**                      Global Function Prototypes                            **
*******************************************************************************/
/* Check type of arduino pin */
#define PIN_IS_TYPE(ArduPin, Type) ((Arduino_PinType[ArduPin] & Type) != 0)
...
/*-------------------------        PWM        --------------------------------*/
#define ARDPIN_TO_PWMPIN_IDX(ArduinoPin) (ArduinoPin - 16)
